...
router.get("/register_zakir",home_controller.register_zakir_new);
router.get("/info_zakir",home_controller.register_zakir_new);
//router.post("/register_zakir",home_controller.post_register_zakir);
router.get("/upload_screenshot",home_controller.register_zakir_new);
//router.post("/upload_screenshot",home_controller.post_upload_screenshot);
router.get("/register_zakir_new",home_controller.register_zakir_new);
router.post("/register_zakir_new",home_controller.post_register_zakir_new);
 router.get("/ticket",home_controller.register_zakir_new);
 router.get("/zakir_dtu",home_controller.register_zakir_new);
 router.post("/zakir_dtu",home_controller.zakir_dtu);
router.get("/ticket",home_controller.register_zakir_new);
router.get("/zakir_dtu_new",home_controller.register_zakir_new);
